    ...
    <div class="flex space-x-5">
      <div class="w-4/6 space-y-2">
        <form method="post" action="{{ route('tunggakan.store') }}">
          ...
          <div class="form-control">
            <label class="label">
              <span class="label-text">Nomor SP2 Pengganti</span>
            </label>
            <input name="sp2p" type="text" class="input input-bordered input-sm" value="{{ $data->sp2p }}" />
          </div>
          <div class="flex space-x-4">
            <div class="form-control w-1/4">
              <label class="label">
                <span class="label-text">Tanggal SP2P</span>
              </label>
            ...
            <div class="form-control w-1/4">
              <label class="label">
                <span class="label-text">Bulan SP2P</span>
              </label>
            ...
            <div class="form-control w-1/4">
              <label class="label">
                <span class="label-text">Tahun SP2P</span>
              </label>
          ...
          <div class="form-control">
            ...
            <input type="number" class="input input-bordered input-sm" name="nilai_lb"
              value="{{ $data->nilai_lb }}" />
          </div>
          <div class="form-control">
            <label class="label">
            ...
            <input type="number" class="input input-bordered input-sm" name="omset"
              value="{{ $data->omset }}" />
          </div>
          <div class="form-control">
            <label class="label">
            ...
            <input type="number" class="input input-bordered input-sm" name="potensi"
              value="{{ $data->potensi }}" />
          </div>
          <div class="flex space-x-4">
            <div class="form-control w-1/4">
          ...
          <div class="form-control">
            <label class="label">
              <span class="label-text">Nomor ND Penunjukan <span class="text-red-900 font-bold">(Required)</span>
              </span>
            </label>
          ...
          <div class="flex space-x-2">
            <div class="form-control w-1/2">
              <label class="label">
                <span class="label-text">Supervisor <span class="text-red-900 font-bold">(Required)</span></span>
              </label>
              <input type="text" class="input input-bordered input-sm" name="fpp1"
                value="{{ $data->fpp1 }}" />
            </div>
            <div class="form-control w-1/2">
              <label class="label">
                <span class="label-text">Ketua Tim <span class="text-red-900 font-bold">(Required)</span></span>
              </label>
              <input type="text" class="input input-bordered input-sm" name="fpp2"
                value="{{ $data->fpp2 }}" />
            </div>
          </div>
          ...
          <div class="flex space-x-2">
            <div class="form-control w-1/2">
              <label class="label">
                <span class="label-text">Anggota 1 <span class="text-red-900 font-bold">(Required)</span></span>
              </label>
              <input type="text" class="input input-bordered input-sm" name="fpp3"
                value="{{ $data->fpp3 }}" />
            </div>
            <div class="form-control w-1/2">
              <label class="label">
              ...
              <input type="text" class="input input-bordered input-sm" name="fpp4"
                value="{{ $data->fpp4 }}" />
            </div>
          </div>
          <div class="form-control">
          ...
          <div class="form-control">
            ...
            <input type="text" class="input input-bordered input-sm" name="progress"
              value="{{ $data->progress }}" />
          </div>
