...
<body class="font-[Poppins]">
  <div class="drawer drawer-mobile">
    ...
    <div class="drawer-content flex flex-col">
      <div class="navbar bg-base-100">
        <div class="flex-1">
          <a class="btn btn-ghost normal-case text-xl">PORTALP3</a>
        </div>
        <div class="flex-none">
          <form method="post" action="{{ route('profil.store') }}">
            ...
            <div class="form-control">
              <div class="input-group">
                <input type="text" placeholder="Masukkan Nama / NPWP" class="input input-bordered" name="npwp" />
  ...
  <div class="drawer-side border-r-2  border-gray-400">
    <label for="my-drawer-2" class="drawer-overlay"></label>
    <ul class="menu p-4 overflow-y-auto w-80 text-base-content">
      <!-- Sidebar content here -->
      <img class="w-64 pb-5 ml-4" src="{{ asset('/assets/png/Vector_dark.png') }}" />
      <li>
      ...
      @if (Auth::user()->roles < 5)
        <li class="menu-title">
          <span>Permohonan Akses Hasil Pemeriksaan</span>
        </li>
        <li>
      ...
      @else
        ...
        <li class="menu-title">
          <span>SKP Hasil Pemeriksaan</span>
        </li>
        <li>
        ...
        <li class="menu-title">
          <span>Administrasi Seksi P3</span>
        </li>
        <li>
